...
import { forwardRef, useCallback, useEffect, useReducer, useRef } from "@wordpress/element";
...
export const Control = forwardRef(function (p, ref) {
  const {
    type,
    className,
    errorMessage,
  ...
  return (
    <div {...{ className }}>
      <div>
        ...
        {state.error && (
          <div className="f6 pa2 red bg-near-white">
